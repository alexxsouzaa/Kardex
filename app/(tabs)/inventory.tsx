...
function getContextLabel(
    ...
    if (filter === 'low') {
        return cat ? `Estoque baixo em ${cat}` : 'Estoque baixo';
    }

    if (filter === 'out') {
        return cat ? `Em falta em ${cat}` : 'Em falta';
    }
...
const Page = () => {
    ...
    const handleRefresh = async () => {
        ...
        // Aguarda um breve instante para a UI mostrar o spinner
        setTimeout(() => {
